...
class DBox2 : public MaxHeapOperators {
...
public:
	...
	DBox2(const DPoint2& p, const DPoint2& q) { pmin = p; pmax = q; }
	...
	GEOMEXPORT void Translate(const DPoint2 &p);
	...
	GEOMEXPORT void EnlargeBy(double s);
	...
	GEOMEXPORT int Contains(const DPoint2& p) const;
