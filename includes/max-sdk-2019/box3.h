...
class Box3: public MaxHeapOperators {
	...
	public:
		...
		*/
		...
		/*! \remarks Determines if the triangle specified by the tree points <b>vert0</b>, <b>vert1</b>, <b>vert2</b> is overlapping 
		with this box.
		\return  Nonzero if the specified triangle overlaps with this box in some way;
		otherwise 0. */
		GEOMEXPORT int Box3::TriBoxOverlap(const Point3 vert0, const Point3 vert1, const Point3 vert2) const; //does the triangle intersect this box at all?
	};
